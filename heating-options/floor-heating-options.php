  ...
  <section class="container-fluid">
    <div class="row section">
      <div class="col-xs-12 col-sm-8 section-sm">
        ...
        <img src="images/product_marble.gif" width="102" height="67" alt="marble heating" class="product-options">
        <img src="images/product_ceramic.gif" width="102" height="67" alt="ceramic floor heating" class="product-options">
        <img src="images/product_stone.gif" width="102" height="67" alt="stone floor heating" class="product-options">
        ...
        <a class="btn" href="under-tile-heating.php">Learn more here</a>

        <strong>Under Carpet Heating</strong>
        ...
        <a class="btn" href="under-carpet-heating.php">Learn more here</a>

        <strong>In Concrete Heating</strong>
        ...
        <img src="images/product_coloured_concrete.gif" width="126" height="67" alt="coloured concrete" class="product-options">
        <img src="images/product_polished_concrete.gif" width="122" height="67" alt="polished concrete" class="product-options">
        <p>Great for your total home heating or selected areas. Installed before the pour of your concrete slab, which can be finished with a multitude of floor coverings or polished concrete.</p>
        <a class="btn" href="in-concrete-heating.php">Learn more here</a>
      </div>
