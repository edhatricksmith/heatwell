...
<head>
<meta charset="utf-8">
<title>Heatwell - Under floor heating specialists</title>
  ...
  <div class="container-fluid">
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-6 col-md-4 section">
        ...
        <a class="btn btn--secondary" href="heating-options/floor-heating-options.php">Learn more</a>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-4 section">
        ...
        <a class="btn btn--secondary" href="diy/do-it-yourself.php">Learn more</a>
      </div>
      <div class="col-xs-12 col-sm-6 col-md-4 section">
