...
<article>
  <section>
    ...
    <div class="content-column unify">
      <h1>Do-It-Yourself Information</h1>
      ...
      <p>
        <ol>
          ...
          <li>Marking the Floor for element installation</li>
          <li>Installation of element</li>
          <li>Install fibreglass mesh</li>
          <li>Laying the tiles</li>
          <li>Wiring and fitting thermostat</li>
          <li>Do's and Don't's</li>
          <li>Final Instructions</li>
        </ol>
        <div class="button-margin"><a class="button" href="DIY.pdf" target="_blank">View D.I.Y. Installation Manual</a></div>
      </p>
      <div class="line-break"></div>
      <h3>Automatic Thermostat Programming Instructions</h3>
      <p>All the information needed to set up and program your automatic thermostat.
        <div class="button-margin"><a class="button" href="../thermostats/thermostat-options.php">View Thermostat Options</a></div>
      </p>
