    ...
    <div class="row section">
      <div class="col-xs-12 col-sm-8">
        ...
        <div class="section-sm">
          ...
          <p>Supply and installing of the draw wires from the thermostat position to the floor. This is done so the element tails can be drawn up at a later date. Please refer to our wiring diagram for draw wire instructions.</p>
          <p><em>All flush boxes for thermostats should be mounted vertically so an automatic thermostat can be fitted.</em></p>
        </div>
        <div class="section-sm">
          <h3>All Trades</h3>
          <p>No one is to walk on the heating elements except the carpet layer.</p>
        </div>
        <div class="section-sm">
          <h3>Carpet Layer</h3>
          <p><strong>Specification For Wiring Under Carpet Heating</strong></p>
          <ol>
