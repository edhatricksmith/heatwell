    ...
    <div class="row section">
      <div class="col-xs-12 col-sm-8 section-sm">
        <div class="Testimonial section-sm">
          ...
          <p><a class="btn btn--secondary" rel="nofollow" href="http://www.awe.co.nz/" target="_blank" >Auckland Wide Electrical</a></p>
        </div>
        <div class="Testimonial section-sm">
          ...
          <p><a class="btn btn--secondary" href="#" target="_blank">Garland Builders Ltd</a></p>
        </div>
        <div class="Testimonial section-sm">
